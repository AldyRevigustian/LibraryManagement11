...
@section('content')
    <section class="section mt-3">
        <div class="card shadow-sm">
            ...
            <div class="card-body">
                <form class="form" action="{{ route('admin.penerbit_store') }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    <div class="row">
                            ...
                            <div class="form-group mandatory">
                                <div class="form-group mandatory">
                                    ...
                                    <div class="image-container mt-5">
                                        <img id="imagePreview" src="" alt="Preview" onclick="openFullImage()" />
                                    </div>
                                </div>
                            </div>
