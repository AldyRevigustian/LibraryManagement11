...
@section('content')
    <section class="section mt-3">
        <div class="card shadow-sm">
            ...
            <div class="card-body">
                <form class="form" action="{{ route('admin.buku_store') }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    <div class="row">
                        ...
                        <div class="col-md-6 col-12">
                            <div class="form-group mandatory">
                                ...
                                <input type="text" id="judul-column"
                                    ...
                                    name="judul" value="{{ old('judul') }}" required autocomplete="judul">
                                @error('judul')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                        ...
                        <div class="col-md-6 col-12">
                            <div class="form-group mandatory">
                                ...
                                <input type="text" id="kontributor-column"
                                    ...
                                    placeholder="Kontributor" name="kontributor" value="{{ old('kontributor') }}" required
                        ...
                        <div class="col-md-6 col-12">
                            <div class="form-group mandatory">
                                ...
                                <input type="number" id="stok-column"
                                    ...
                                    name="stok" value="{{ old('stok') }}" required autocomplete="stok">
                                @error('stok')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                        ...
                        <div class="col-md-6 col-12">
                            <div class="form-group mandatory">
                                ...
                                <input type="text" id="tahun_terbit-column"
                                    ...
                                    placeholder="Tahun terbit" name="tahun_terbit" value="{{ old('tahun_terbit') }}"
                        ...
                        <div class="col-md-12 col-12">
                            <div class="form-group mandatory">
                                ...
                                <textarea class="form-control @error('deskripsi') is-invalid @enderror" id="deskripsi-column" placeholder="Deskripsi"
                                    name="deskripsi" value="{{ old('deskripsi') }}" required autocomplete="deskripsi" rows="5"></textarea>
                                @error('deskripsi')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
